footer: GENDER DIVERSITY IN TECH: ADDRESSING THE PIPELINE & CREATING THE CULTURE | @nancynaluz
slidenumbers: false
...
^ I want to introduce this talk with a number of statistics
...
^ US researchers analysed 1.4 million users on GitHub and found that women are more likely to have their PRs accepted
...
^ Luddite: someone who is terrified of technology. I didn't understand it. Why are we so obssessed with the newest applications. I thought technology was ultimately bad for the environment.
...
^ I attended a workshop in Toronto having almost no programming experience whatsoever.

^ I took one programming class in high school with 20 boys and 5 girls. The class had divided itself by gender and it was a completely horrible experience where I barely understood what was going on.
...
^ Founded in 2014 going on to our 2nd year we are now 3 Chapter Leads (Cassie L. Rhéaume spearheading Ladies Learning Code to become more bilingual, Iva Olah in charge of the youth workshops, and myself). We've had 40 workshops, +900 participants and +300 mentors at our events.
...
^ And looking back at my previous life as a Luddite, I've been reflecting and trying to understand why exactly I had been so adverse to technology for such a long time. What made me draw the conclusion that technology was inaccessible?
...
^ Rooney Rule: At least one women and one underrepresented minority must be considered in the slate of candidates for every open position
...
^ They grew their Female Engineer team by almost 500% in one year.
^ http://firstround.com/review/How-Etsy-Grew-their-Number-of-Female-Engineers-by-500-in-One-Year/
...
^ So we've talked about the pipeline that inhibits women from entering the industry. But it's certainly not the only thing
...
^ Usually when I give this talk, I point it to education. But I think we can do better. Studies have shown that women are attending university for computer science but they don't stay there.
...
^ Reshma Saujani believes that we're not raising our girls to embrace failure.

^ I revealed this recently in an interview with Andrea Zoellner that the hardest part about getting started in this industry was realizing that you don't know everything. A lot of the beginnings of being a web developer is Googling, Stack Overflow and asking help from your peers. I've been in this field for a year and a half now and I'm still constantly asking for help from my peers and doing code reviews for the littlest things. Sometimes failing at something again and again breaks your heart and you don't have the motivation to keep going. That happens even to me. It's a hard thing to admit to yourself that you don't know everything but you realize you're not the only one.
...
^ Front-End Engineer at TedTalks formerly at HackerYou

^ Every single JavaScript developer needs to watch this video.

^ How we can be more welcoming to new developers

^ Which way is the right way? Constantly critiquing people about using last year's model. Anger against jQuery. Strongly opinionated developer community that is incredibly passionate but these ideas are so alienating to newcomers that want to grasp the basic fundamentals of programming. Angular vs React. Grunt vs. Gulp. Python vs. Ruby. Ew, PHP? We've heard it all and I'm not going to lie, I'm guilty of this, too. But this is not something that we need to talk about when we're doing tutorials or showing something completely foreign to someone coming in. Let them figure it out for themselves if that's for them.

^ Ultimately, we need to create empathy and remember what it was like to be a junior developer just starting.
...
^ How does Slack think about this? Read more about this (http://slackhq.com/post/107934093600/building-the-workplace-we-want)

^ They stress that they want to build empathy, their CEO pays tribute to Martin Luther King and an engineer later shared it on Medium
...
^ What with the hostile work environments
...
^ Julie Ann Horvath at GitHub, Ellen Pao at Kleiner Perkins, and the countless stories that have been encountered on Model View Culture. These are just some of the examples we've heard of hostile work environments that can ultimately result in women leaving the industry.

^ I think it's important that a company acknowledges these issues.
...
^ Recently at Dynamo a discussion that without context was inappropriate and our co-founder Alex Nemeroff intervened by sending a mass email to the entire staff:
...
^ To me, this was a fantastic example of how a company can intervene and draw the boundaries when it comes to inappropriate discussion.
...
^ I wouldn't be where I am today if it weren't for these women in tech groups that have inspired me and have helped me built a network of people that are excited about the initiative to make the industry more diverse.
^ Pixelles, Montreal All Girl Hack Night, PyLadies, Yes Montreal Women in Tech, Montreal Girl Geeks
^ I went to these meetups before Ladies Learning Code was even a thing in Montreal and the conversations and the women I've met at these meetups have inspired me.
...
^ Am I saying that everyone needs to be a developer? Am I saying that from this point forward that your team should only hire female developers? Not really. I think that learning to code should be accessible. I think we should teach our kids about technology and coding so that they don't have these assuming ideas of whether or not the tech field is for them. I think that companies and those that are hiring should be aware of these issues and conscious when their team is all male. I think when we say that we are proud of our company culture, we need to address what that means and whether or not that culture has allowed for diversity to grow.

^ It's great that Facebook, Google, and many tech corporations are becoming transparent about their diversity numbers. I think that when addressing diversity it's not just about addressing the pipeline but it's also the culture.  We want to keep those people there. It's not just about hiring for the sake of hiring but providing also the mentorship and support that these new devs need.

^ I am not saying that I have all the answers. In fact, I'd love to hear more. The only thing I can say is that this is my experience. Prior to coming into this two years ago, I knew nothing about tech, didn't know about startups, thought it was all men, thought programming was an isolated experience. Little did I know, coding can be incredibly colloborative, fun and that the community itself wants to change.

^ Sure, it's only been two years, but I'm still here. I stayed because I surrounded myself with a community I love and people I love to work with. I think that's pretty cool and I'm hoping that more women experience this, too.
